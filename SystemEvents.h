...
typedef enum {
	SystemEventsActnItemsAdded = 'fget' /* items added */,
	SystemEventsActnItemsRemoved = 'flos' /* items removed */,
	SystemEventsActnWindowClosed = 'fclo' /* window closed */,
	SystemEventsActnWindowMoved = 'fsiz' /* window moved */,
	SystemEventsActnWindowOpened = 'fopn' /* window opened */
} SystemEventsActn;
...
- (SystemEventsFolderAction *) attachActionToUsing:(NSString *)using_;  // Attach an action to a folder
- (NSArray *) attachedScripts;  // List the actions attached to a folder
- (SystemEventsFile *) editActionOfUsingActionName:(NSString *)usingActionName usingActionNumber:(NSInteger)usingActionNumber;  // Edit an action of a folder
- (SystemEventsFolderAction *) removeActionFromUsingActionName:(NSString *)usingActionName usingActionNumber:(NSInteger)usingActionNumber;  // Remove a folder action from a folder
...
@property (copy, readonly) NSString *objectDescription;  // a more complete description of the UI element and its capabilities
...
@property (copy, readonly) NSString *help;  // an encoded description of the UI element and its capabilities
